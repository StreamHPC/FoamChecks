...
#define MAXMIN(R, T1, T2) \
    inline R min(const T1, const T2){ return 0; } \
    inline R max(const T1, const T2){ return 0; }

#define MAXMINPOW(retType, type1, type2) MAXMIN(retType, type1, type2)
